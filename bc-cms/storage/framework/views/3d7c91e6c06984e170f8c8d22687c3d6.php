...
?>
<div class="item-loop item-hotel <?php echo e($wrap_class ?? ''); ?>">
    ...
    <div class="thumb-image ">
        ...
        <!--[if BLOCK]><![endif]--><?php if($row->star_rate): ?>
            <div class="star-rate">
                <div class="list-star">
                    <ul class="booking-item-rating-stars">
                        <!--[if BLOCK]><![endif]--><?php for($star = 1 ;$star <= $row->star_rate ; $star++): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if(setting_item('hotel_enable_review')): ?>
    <?php
...
<?php /**PATH /var/www/bc-cms/themes/BC/Hotel/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>