...
<div class="bc-offer">
    <!--[if BLOCK]><![endif]--><?php if(!empty($list_item)): ?>
    <div class="container">
        <div class="row">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $list_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $size = 3 ; if($key == 0) $size = 6; ?>
                <div class="col-lg-<?php echo e($size); ?>">
                    <div class="item">
                        <!--[if BLOCK]><![endif]--><?php if(!empty($item['featured_text'])): ?>
                            <div class="featured-text"><?php echo e($item['featured_text']); ?></div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        <!--[if BLOCK]><![endif]--><?php if(!empty($item['featured_icon'])): ?>
...
<?php /**PATH /var/www/bc-cms/themes/Base/Template/Views/frontend/blocks/offer-block/index.blade.php ENDPATH**/ ?>