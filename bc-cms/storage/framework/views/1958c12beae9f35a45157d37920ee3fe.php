<div class="container">
    <div class="bc-list-event layout_<?php echo e($style_list); ?>">
                ...
                <div class="row">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-<?php echo e($col ?? 3); ?> col-md-6">
                            <?php echo $__env->make('Event::frontend.layouts.search.loop-grid', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
...
<?php /**PATH /var/www/bc-cms/themes/BC/Event/Views/frontend/blocks/list-event/index.blade.php ENDPATH**/ ?>