...
?>
<div class="item-loop item-event item-loop-wrap <?php echo e($wrap_class ?? ''); ?>">
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <!--[if BLOCK]><![endif]--><?php if(!empty($time = $row->start_time)): ?>
...
<?php /**PATH /var/www/bc-cms/themes/BC/Event/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>