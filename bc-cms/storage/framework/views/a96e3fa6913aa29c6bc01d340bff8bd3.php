...
?>
<div class="item-loop item-car item-loop-wrap <?php echo e($wrap_class ?? ''); ?>"  wire:loading.class="skeleton-loading">
    ...
    <div class="amenities">
        <!--[if BLOCK]><![endif]--><?php if($row->passenger): ?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if($row->gear): ?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if($row->baggage): ?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if($row->door): ?>
...
<?php /**PATH /var/www/bc-cms/themes/BC/Car/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>