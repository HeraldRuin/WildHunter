...
?>
<div class="item-loop item-boat item-loop-wrap <?php echo e($wrap_class ?? ''); ?> b-bg-white" wire:loading.class="skeleton-loading">
    ...
    <div class="item-title">
        ...
        <!--[if BLOCK]><![endif]--><?php if(setting_item('boat_enable_review')): ?>
            <?php
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <div class="amenities">
        <!--[if BLOCK]><![endif]--><?php if($row->max_guest): ?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if($row->cabin): ?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if($row->length): ?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if($row->speed): ?>
...
<?php /**PATH /var/www/bc-cms/themes/BC/Boat/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>