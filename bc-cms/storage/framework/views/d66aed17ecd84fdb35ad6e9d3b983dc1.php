...
<?php $__env->startSection('container'); ?>
    <div class="tabs tabs-full">
        ...
        <input id="tab1" type="radio" name="tabs" value="tab1" class="tab-input" <?php if(old('tabs','tab1') == 'tab1'): ?> checked <?php endif; ?> />
        <input id="tab2" type="radio" name="tabs" value="tab2" class="tab-input" <?php if(old('tabs') == 'tab2'): ?> checked <?php endif; ?> />
        <input id="tab3" type="radio" name="tabs" value="tab3" class="tab-input" <?php if(old('tabs') == 'tab3'): ?> checked <?php endif; ?> />
        <form method="post" action="<?php echo e(route('LaravelInstaller::environmentSaveWizard')); ?>" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group <?php echo e($errors->has('app_name') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Booking Core"
                ...
                <div class="form-group <?php echo e($errors->has('environment') ? ' has-error ' : ''); ?>" style="display: none">
                    ...
                    <select name="environment" id="environment" onchange='checkEnvironment(this.value);'>
                        <option value="local" selected>
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_environment_label_local')); ?></option>
                        <option value="development">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_environment_label_developement')); ?>

                        </option>
                        <option value="qa">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_environment_label_qa')); ?></option>
                        ...
                        <option value="other">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_environment_label_other')); ?></option>
                    </select>
                ...
                <div class="form-group <?php echo e($errors->has('app_log_level') ? ' has-error ' : ''); ?>" style="display: none">
                    ...
                    <select name="app_log_level" id="app_log_level">
                        ...
                        <option value="info">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_log_level_label_info')); ?></option>
                        <option value="notice">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_log_level_label_notice')); ?></option>
                        <option value="warning">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_log_level_label_warning')); ?></option>
                        <option value="error">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_log_level_label_error')); ?></option>
                        <option value="critical">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_log_level_label_critical')); ?></option>
                        <option value="alert">
                            <?php echo e(trans('installer_messages.environment.wizard.form.app_log_level_label_alert')); ?></option>
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group d-none <?php echo e($errors->has('database_connection') ? ' has-error ' : ''); ?>"
                    style="display: none">
                    ...
                    <select name="database_connection" id="database_connection">
                        ...
                        <option value="sqlite">
                            <?php echo e(trans('installer_messages.environment.wizard.form.db_connection_label_sqlite')); ?></option>
                        <option value="pgsql">
                            <?php echo e(trans('installer_messages.environment.wizard.form.db_connection_label_pgsql')); ?></option>
                        <option value="sqlsrv">
                            <?php echo e(trans('installer_messages.environment.wizard.form.db_connection_label_sqlsrv')); ?></option>
                    </select>
                ...
                <div class="form-group <?php echo e($errors->has('database_name') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="database_name" id="database_name" value="<?php echo e(old('database_name')); ?>"
                ...
                <div class="form-group <?php echo e($errors->has('database_username') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="database_username" id="database_username" value="<?php echo e(old('database_username')); ?>"
                ...
                <div class="form-group <?php echo e($errors->has('admin_email') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="admin_email" id="admin_email" maxlength="100" value="<?php echo e(old('admin_email')); ?>" required
                        placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_admin_email_placeholder')); ?>" />
                ...
                <div class="form-group <?php echo e($errors->has('admin_password') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="password" name="admin_password" id="admin_password" value="" minlength="8" required
                        placeholder="<?php echo e(trans('installer_messages.environment.wizard.form.app_admin_password_placeholder')); ?>" />
                ...
                <div class="buttons">
                    <span class="button bc_test_db" style="font-size: 17px;"><?php echo e(__('Test DB')); ?></span>
                ...
                <div class="block">
                    ...
                    <div class="info">
                        <div class="form-group <?php echo e($errors->has('mail_driver') ? ' has-error ' : ''); ?>">
                            ...
                            <input type="text" name="mail_driver" id="mail_driver" value="sendmail"
...
<?php echo $__env->make('vendor.installer.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/bc-cms/resources/views/vendor/installer/environment-wizard.blade.php ENDPATH**/ ?>