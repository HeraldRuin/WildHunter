...
<div class="form-group">
	...
	<div class="form-content" wire:ignore>
		...
		<!--[if BLOCK]><![endif]--><?php if($location_search_style=='autocompletePlace'): ?>
			<div class="g-map-place" >
				<input type="text" name="map_place" placeholder="<?php echo e(__("Where are you going?")); ?>"  value="<?php echo e($map_place); ?>" class="form-control border-0">
				<div class="map d-none" id="map-<?php echo e(\Illuminate\Support\Str::random(10)); ?>"></div>
				<input type="hidden" wire:model="map_lat" value="<?php echo e($map_lat); ?>">
				<input type="hidden" wire:model="map_lng" value="<?php echo e($map_lng); ?>">
			</div>
		<?php else: ?>
            <?php
            $location_name = "";
			...
			<div class="smart-search">
				...
				<input type="hidden" class="child_id" name="location_id" value="<?php echo e($location_id); ?>">
			</div>
		<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
	</div>
</div>

<?php /**PATH /var/www/bc-cms/themes/BC/Tour/Views/frontend/layouts/search/fields/location.blade.php ENDPATH**/ ?>