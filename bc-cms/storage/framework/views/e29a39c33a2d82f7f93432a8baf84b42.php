    ...
    <div class="form-content">
        ...
        <!--[if BLOCK]><![endif]--><?php if($location_search_style=='autocompletePlace'): ?>
            <div class="g-map-place" >
                ...
                <input type="hidden" name="map_lng" value="<?php echo e(request()->input('map_lng')); ?>">
            </div>
...
<?php /**PATH /var/www/bc-cms/themes/BC/Hotel/Views/frontend/layouts/search/fields/location.blade.php ENDPATH**/ ?>