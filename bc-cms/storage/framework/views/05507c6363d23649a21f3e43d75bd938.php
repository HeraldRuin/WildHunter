<form class="form bc-form-register" method="post" action="<?php echo e(route('auth.register.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row">
...
<?php /**PATH /var/www/bc-cms/modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>