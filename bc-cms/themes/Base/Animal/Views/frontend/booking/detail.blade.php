    ...
    <div class="booking-review-content">
        ...
        <div class="review-section">
            <ul class="review-list">
                @if($pick_up = $booking->getMeta('pick_up') )
                    <li>
                        <div class="label">{{__('Pick up:')}}</div>
                        <div class="val">
                            {{ $pick_up }}
                        </div>
                    </li>
                @endif
                @if($drop_off = $booking->getMeta('drop_off') )
                    <li>
                        <div class="label">{{__('Drop off:')}}</div>
                        <div class="val">
                            {{ $drop_off }}
                        </div>
                    </li>
                ...
                @if($booking->start_date)
                    <li>
                        <div class="label">{{__('Hunting date:')}}</div>
                        <div class="val">
