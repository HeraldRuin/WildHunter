...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{!empty($recovery) ? __('Recovery') : __("All Animals")}}</h1>
            <div class="title-actions">
                @if(empty($recovery))
                <a href="{{route('animal.admin.create')}}" class="btn btn-primary">{{__("Add new animal")}}</a>
                @endif
            </div>
        </div>
...
{{--                                    </td>--}}
                                    ...
                                    <td>
                                        @if(empty($recovery))
                                            <a href="{{route('animal.admin.edit',['id'=>$row->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> {{__('Edit')}}</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
