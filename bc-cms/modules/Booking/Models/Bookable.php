<?php
    ...
    class Bookable extends BaseModel
    {
        ...
        public $type                               = '';
        public $hasLocationFeature = true;
        ...
        {
            return $this->hasOne(app(\Modules\User\Models\UserWishList::class), 'object_id', 'id')->where('object_model', $this->type)->where('user_id', auth()->id() ?? 0);
        }
